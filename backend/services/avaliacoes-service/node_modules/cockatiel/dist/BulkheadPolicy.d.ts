...
export declare class BulkheadPolicy implements IPolicy {
     ...
     * @inheritdoc
     */
    readonly onSuccess: import("./common/Event.js").Event<import("./Policy.js").ISuccessEvent>;
    /**
     * @inheritdoc
     */
    readonly onFailure: import("./common/Event.js").Event<import("./Policy.js").IFailureEvent>;
    /**
     * Emitter that fires when an item is rejected from the bulkhead.
     */
    readonly onReject: import("./common/Event.js").Event<void>;
    /**
